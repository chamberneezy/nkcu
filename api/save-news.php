...
// Optional: same pattern as save-goal.php/save-squad.php — the iOS app
// sends its own per-user session token alongside the shared password
// purely so we know WHO published/edited this item.
